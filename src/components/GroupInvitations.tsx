      ...
      <AnimatePresence mode="popLayout">
        {invitations.map((invitation) => (
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
            className="bg-gradient-to-r from-fuchsia-500/10 to-violet-500/10 border border-fuchsia-500/30 rounded-xl p-4"
          >
            <div className="flex items-start gap-3">
              {/* Group Icon */}
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-fuchsia-500 to-violet-500 flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white font-medium">{invitation.groupName}</p>
                <p className="text-zinc-400 text-sm">
                  Invited by {formatAddress(invitation.inviterAddress)}
                </p>
            ...
            <div className="flex gap-2 mt-3">
              ...
              <button
                ...
                disabled={processingId === invitation.id}
                className="flex-1 py-2 px-3 rounded-lg bg-gradient-to-r from-fuchsia-600 to-violet-600 hover:from-fuchsia-700 hover:to-violet-700 text-white text-sm font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
              >
