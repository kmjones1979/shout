        ...
        <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-2xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm">Passkey verified</p>
            </div>
          </div>
          ...
          {mode === "register" && (
            ...
            >
              <input
                ...
                className="w-full py-3 px-4 bg-zinc-900/70 border border-zinc-800 rounded-xl text-white placeholder:text-zinc-500 focus:outline-none focus:border-violet-500/50 focus:ring-2 focus:ring-violet-500/20 transition-all"
              />
            </motion.div>
          )}
        </AnimatePresence>
